...
<!--  jquery core -->
<script src="<?php echo ADMINJS_PATH ?>jquery/jquery-1.4.1.min.js" type="text/javascript"></script>
...
<div id="login-holder">
	...
	<!-- start logo -->
	<div id="logo-login">
		<a href="index.html"><img src="<?php echo ADMINIMAGES_FOLDER ?>shared/logo.png" width="156" height="40" alt="" /></a>
	</div>
	<!-- end logo -->
	...
	<!--  start loginbox ................................................................................. -->
	<div id="loginbox">
	<form action="<?php echo ROOT_FOLDER?>adminlogin/validatelogin" method="post">
	<!--  start login-inner -->
	<div id="login-inner">
		...
		<tr>
			<th>Password</th>
			<td><input name="pwd" id="pwd" type="password" onfocus="this.value=''" class="login-inp" /></td>
		</tr>
		<tr>
			<th></th>
